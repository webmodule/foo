...
var bootstrap = (function() {
    ...
    function createScriptElement(scriptSrc, scriptId) {
        var scriptTag = document.createElementNS('http://www.w3.org/1999/xhtml', 'html:script')
...
If you'd like to specify multiple files, you can either pass in an array containing
the names/urls of the scripts you would like to load or you can pass in a config object
using the following format:
{
    "{id for the script tag}" : "{name or url for the script}"
}
